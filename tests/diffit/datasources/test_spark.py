""":mod:`diffit.datasources.spark` unit test cases.
...
def test_parquet_reader(working_dir: Text, spark: SparkSession):
...
def test_parquet_write_read(working_dir: Text, spark: SparkSession, dummy: DataFrame):
